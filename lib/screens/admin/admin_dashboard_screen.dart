    ...
    return SafeArea(
      child: StreamBuilder<List<FeedbackModel>>(
        ...
        builder: (context, snapshot) {
          ...
          final filtered = _filter == null ? all : all.where((e) => e.status == _filter).toList();
            ...
            slivers: [
              ...
              if (!snapshot.hasData)
                ...
                const SliverToBoxAdapter(
                  child: EmptyState(title: 'Nothing here', message: 'No feedback matches this filter yet.', icon: Icons.filter_alt_off_rounded),
                )
              else
                SliverPadding(
